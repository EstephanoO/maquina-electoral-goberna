...
Project context bridge: this skill file is generic guidance, but operational and architectural decisions for this repo are governed by `/AGENTS.md` (root source of truth).
