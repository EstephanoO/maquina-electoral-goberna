...
export function SlideHerramientas() {
  return (
    <div className="relative flex-1 flex flex-col rounded-2xl overflow-hidden border border-white/5 shadow-2xl bg-[#020a1e]">
      {/* Header */}
      <header className="relative px-8 sm:px-12 py-6 sm:py-7 border-b border-white/5 text-center">
        <EditorialHeader
      ...
      {/* Cards grid — fills remaining height, anchored top */}
      <div className="flex-1 p-6 grid grid-cols-2 lg:grid-cols-3 gap-4 content-start">
        {herramientas.map((h, i) => (
          <motion.div
            ...
            className="bg-[#0a1e4a] border border-white/10 rounded-2xl p-5 hover:bg-white/[0.06] hover:border-white/15 transition-all cursor-pointer"
          >
