      ...
      <div style={{ position: "relative", maxWidth: 480, width: "100%", margin: "0 auto", padding: "60px 20px 40px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 14, color: "rgba(255,255,255,0.45)", margin: 0, lineHeight: 1.5 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(37,211,102,0.6)" }}>v10.5.1</span>
          </p>
        </div>
        ...
        {view === "intro" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: 20 }}>
              ...
              <Feature icon="safe" title="Sin duplicados" desc="6 capas anti-duplicado: ContactCollection, lastReceivedKey, localStorage, realtime backend y blast_log" />
