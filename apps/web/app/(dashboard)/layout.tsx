...
const NAV_ITEMS: NavItem[] = [
  ...
  // Gestion: admin y consultor — excluye candidato
...
// ── Notifications button (sidebar bottom, admin + consultor) ────────
...
function NotificationsButton({ showLabel, isMobile, onClose }: { showLabel: boolean; isMobile: boolean; onClose: () => void }) {
              ...
              {loading ? (
                ...
                notifications.map((n) => (
                  <div key={n.id} style={{
                    ...
                    <span style={{ width: 8, height: 8, borderRadius: "50%", background: typeColors[n.type] ?? "#94A3B8", flexShrink: 0, marginTop: 4 }} />
    ...
    >
      ...
      >
        ...
        <div style={{ flexShrink: 0 }}>
          {/* Notificaciones — visible para admin y consultor */}
          {(uiRole === "admin" || uiRole === "consultor") && (
            <NotificationsButton showLabel={showLabel} isMobile={isMobile} onClose={() => setMobileOpen(false)} />
          )}
