/**
 * demo-legua-icons.tsx — Inline SVG icons for DemoLeguaBanner.
 *
 * Extracted from demo-legua-banner.tsx to reduce component size.
 */

export function MapIcon({ color = "#3b82f6" }: { color?: string }) {
  return (
...
export function UsersIcon({ color = "#10b981" }: { color?: string }) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function ChartIcon({ color = "#f59e0b" }: { color?: string }) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function PhoneIcon({ color = "#8b5cf6" }: { color?: string }) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
