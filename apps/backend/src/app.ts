...
import { buildOnboardingFase1CatalogosRoutes } from "./modules/onboarding-fase1/catalogos/routes";
import { buildOnboardingFase1CandidatosRoutes } from "./modules/onboarding-fase1/candidatos/routes";
import { buildOnboardingFase1DeckRoutes } from "./modules/onboarding-fase1/deck/routes";
...
import { buildVoluntariosRoutes } from "./modules/voluntarios/routes";
...
export function buildApp(env: AppEnv) {
  ...
  app.register(buildOnboardingFase1CatalogosRoutes(env));
  app.register(buildOnboardingFase1CandidatosRoutes(env));
  app.register(buildOnboardingFase1DeckRoutes(env));
  ...
  app.register(buildVoluntariosRoutes(env));
